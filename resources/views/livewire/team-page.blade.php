 ...
 <section class="breadcrumb-area">
    <div class="breadcrumb-area-bg"
        style="background-image: url('{{ asset("public/box/images/team.jpg") }}');"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<section class="team-style1-area">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="single-team-style1 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                    ...
                    <div class="text-holder">
                        <h3><a href="#">Bret Ke Danielle</a></h3>
                        <h5>Founder & CEO</h5>
                    </div>
                </div>
            </div>
            ...
            <!--Start Single Team Style1-->
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="single-team-style1 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="img-holder">
                        <div class="inner">
            ...
            <!--Start Single Team Style1-->
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="single-team-style1 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="img-holder">
                        <div class="inner">
