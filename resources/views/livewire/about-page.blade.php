        ...
        <div class="row">
                ...
                <div class="intro-style1-video-gallery">
                    ...
                    <div class="intro-video-gallery-style1">
                        <div class="icon wow zoomIn animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <a class="video-popup" title="Video Gallery" href="https://www.youtube.com/watch?v=pXZQBKZCWfc">
            ...
            <div class="col-xl-6">
                <div class="intro-style1-content-box">
                    <div class="sec-title">
                        <h2>We are - a bridge to expansion</h2>
                    </div>
                    <div class="text">
                        <p>
...
<section class="facts-area">
    ...
    <div class="container">
        <div class="sec-title text-center">
            ...
            <div class="sub-title">
                <p>Numbers that speak about lending service.</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="single-fact-box">
                    ...
                    <div class="text">
                        <h3>Our Network</h3>
                        <p>3 Branches around the country</p>
                    </div>
                </div>
            </div>
            <!--End Single Fact Box-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="single-fact-box">
                    ...
                    <div class="text">
                        ...
                        <p>K9, 245.6  loans for 11 customers</p>
                    </div>
                </div>
            </div>
            <!--End Single Fact Box-->
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="statistics-content-box">
                    <div class="sec-title">
                        <h2>Better Value<br> Financing Experience</h2>
                    </div>
                    <div class="text">
                        <p>
            ...
            <div class="col-xl-6">
                <div class="statistics-chart">
                    <img src="{{ asset('box/images/resources/statistics-chart.png') }}" alt="">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="awards-img-box">
                    ...
                    <div class="shape2">
                        <img src="{{ asset('assets/images/resources/trophy-shape-2.png') }}" alt="">
                    </div>
                    <div class="inner">
                        <img src="{{ asset('box/images/resources/trophy.png') }}" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4">
                <div class="awards-achivements-right-box">
                    ...
                    <div class="single-awards-achivements-box">
                        <div class="top">
                            <div class="icon">
                                <img src="{{ asset('box/images/icon/award-1.png') }}" alt="">
                            </div>
                            <div class="inner-title">
