        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#createUserModeling" class="btn btn-square btn-primary">Post New Job</button>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table wire:ignore.self id="example5" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="text-align:center"><a href="javascript:void(0);"><strong>{{ $career->dept }}</strong></a></td>
                                    <td style="text-align:center"><a href="javascript:void(0);"><strong>{{ $career->job_role }}</strong></a></td>
                                    ...
                                    <td style="text-align:center">
                                        <div class="d-flex">
                                            ...
                                            <button wire:click="destory({{ $career->id }})" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        </div>												
                                    </td>												
                                </tr>
                                @empty
