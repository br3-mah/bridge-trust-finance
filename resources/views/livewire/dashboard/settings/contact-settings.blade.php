        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body pb-0">
                    <form wire:model.prevent="store()" novalidate enctype="multipart/form-data">
                        @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="mb-2">
                                                            <div class="col-8">
                                                                <div class="border-2 border-dashed shadow-sm border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary w-full">Add Logo</button>
                                                                        <input type="file" id="prof_image_create" name="logo_file" class="w-full h-full top-0 left-0 absolute opacity-0"> 
                                                                    </div>
                                                                </div>
                                                            </div>                                                        
                                                        </div>
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <input type="text" class="form-control" id="validationCustom01" value="{{ $contacts->name ?? '' }}" wire:model="name"  placeholder="Enter a Business Name.." required>
