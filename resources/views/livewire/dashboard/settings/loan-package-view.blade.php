        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#newloanpackage" class="btn btn-square btn-primary">New Loan Package</button>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <span class="d-flex justify-content-end">
                                            ...
                                            <a href="javascript:void(0);" wire:click="destroy({{$item->id}})" class="btn btn-danger shadow btn-xs sharp" data-bs-toggle="tooltip"
