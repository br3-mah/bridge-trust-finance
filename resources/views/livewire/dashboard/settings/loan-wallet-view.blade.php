                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card recent-activity">
                                ...
                                <div class="card-body p-0 pb-3">
                                    ...
                                    @endempty
                                    <div class="p-4">
                                        <button class="btn btn-primary btn-square" data-bs-toggle="modal" data-bs-target="#loanWalletFundsModal" >
            ...
            <div class="modal-content">
                ...
                <form method="POST" wire:submit.prevent="store()">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-square light" data-bs-dismiss="modal">Close</button>
                        <button id="update-loan-wallet-toastr-success-bottom-left" type="submit" data-bs-dismiss="modal" class="btn btn-primary btn-square">Save changes</button>
                    </div>  
                </form>
            </div>
        </div>
