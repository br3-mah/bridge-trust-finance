                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $user->fname }}" name="fname" class="form-control" placeholder="{{ $user->fname ?? 'John' }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="mb-3">
                                        <label class="text-label form-label">Last Name*</label>
                                        <input type="text" value="{{ $user->lname }}" name="lname" class="form-control" placeholder="{{ $user->lname ?? 'Doe' }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="mb-3">
                                        <label class="text-label form-label">Email Address*</label>
                                        <input type="email" name="email" value="{{ $user->email }}" class="form-control" id="inputGroupPrepend2" aria-describedby="inputGroupPrepend2" placeholder="{{ $user->email ?? 'example@mail.com' }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="mb-3">
                                        <label class="text-label form-label">Phone Number*</label>
                                        <input type="text" value="{{ $user->phone }}" name="phone" class="form-control" placeholder="(+260)97-000-999" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2">
                                    <div class="mb-3">
                                        <label class="text-label form-label">Gender*</label>
                                        <select type="text" name="gender" value="{{ $user->gender }}" class="form-control">
