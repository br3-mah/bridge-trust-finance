                        ...
                        <div class="profile-info">
                            <div class="profile-photo">
                                @if($data->profile_photo_path == null)
                                    ...
                                    @endif
                                @else
                                    <img class="w-30 h-40 img-fluid rounded-circle bg-primary" src="{{ 'public/'.Storage::url($data->profile_photo_path) }}" />
                                @endif
                            </div>
                                        ...
                                        @if($data->loans->first() != null)
                                            ...
                                            <div class="balance_data">
                                                ...
                                                <div class="balance_info">
                                                    ...
                                                    <h4>K {{ App\Models\Loans::loan_balance($data->loans->id) }}</h4>
                                                </div>
                                            </div>
                                            @endif
