...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#ad3903;">
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                <a href="https://bridgetrustfinance.co.zm" style="text-decoration:none;">
                  <img width="20" style="width:20; height:20" alt="Bridge Trust Finance" src="https://bridgetrustfinance.co.zm/public/box/images/resources/logo-11.png">
                </a>
              </td>
            </tr>
            <!--  Intro Section -->
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <a class="btn btn-primary" href="https://bridgetrustfinance.co.zm/login">Login</a>
                <br>
                <p>Best Regards</p>
              </td>
            </tr>
            <tr>
              <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:#ffeada;color:#384049;border: 1em solid #fff;">
                <p style="margin:0 0 0.75em 0;line-height: 0;">
                  <!--      LinkedIn logo            -->
                  <a href="linkedin.com" style="display:inline-block;text-decoration:none;margin: 0 5px;">
                  ...
                  <!--      Facebook logo            -->
                  <a href="facebook.com" style="display:inline-block;text-decoration:none;margin: 0 5px;">
                  ...
                  <!--     Instagram logo               -->
                  <a href="instagram.com" style="display:inline-block;text-decoration:none;margin: 0 5px;">
                ...
                <p style="margin:0;font-size:.75rem;line-height:1.5em;text-align: center;">
                  Bridge Trust Finance, Stand B19 CBU, Jambo Drive, Riverside, Kitwe.
                  <br>
                  <a class="unsub" href="bridgetrustfinance.com" style="color:#384049;text-decoration:underline;">Unsubscribe</a>
                </p>
              </td>
            </tr>
          </table>
