...
<body style="margin:0;padding:0;word-spacing:normal;background-color:#7B1001;">
      ...
      <tr>
        <td align="center" style="padding:0;">
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
            <!--  Logo headder -->
            <tr>
              <td style="padding:30px 20px 20px 20px;text-align:center;font-size:1.5em;font-weight:bold; background: #7B1001;">
                <a href="https://bridgetrustfinance.co.zm" style=" text-decoration:none;">
                  <img style="width:120px; height:90px" alt="Bridge Trust Finance" src="https://bridgetrustfinance.co.zm/public/box/images/resources/logo-11.png">
                </a>
              </td>
            </tr>
            <!--  Intro Section -->
            ...
            <tr>
              <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:#ffeada;color:#384049;border: 1em solid #fff;">
                ...
                <p style="margin:0;font-size:.75rem;line-height:1.5em;text-align: center;">
                  ...
                  <br>
                  <a class="unsub" href="https://bridgetrustfinance.co.zm" style="color:#384049;text-decoration:underline;">Unsubscribe</a>
                </p>
              </td>
            </tr>
          </table>
