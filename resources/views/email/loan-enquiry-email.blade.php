            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                <a href="https://bridgetrustfinance.co.zm" style="text-decoration:none;">
                  <img width="50" alt="Bridge Trust Finance" src="https://bridgetrustfinance.co.zm/public/box/images/resources/logo-11.png">
                </a>
              </td>
            </tr>
            <!--  Intro Section -->
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="text-align: left;">
                    {{  $data['name']  }} expresses interest in obtaining a {{  $data['type']  }} Loan with Bridge Trust Finanance. 
                    <br>
                    <br>
                    <br>
