            ...
            <tr>
              <td style="padding:40px 30px 30px 30px;text-align:center;font-size:1.5em;font-weight:bold;">
                <a href="http://dopplerhealth.com/" style="text-decoration:none;">
                  <img width="2170" alt="Bridge Trust Finance" style="width:2170px;max-width:80%;height:auto;border:none;text-decoration:none;color:#750303;" src="https://bridgetrustfinance.co.zm/public/box/images/resources/logo-11.png">
                </a>
              </td>
            </tr>
            <!--      Intro Section -->
            <tr>
              <td style="padding:30px;background-color:#ffffff;">
                ...
                <p style="text-align: center;margin: 2.5em auto;">
                  <a class="button" href="{{ $actionUrl }}" style="background: #752702; 
                ...
                <p>Thank you for your time and for using Bridge Trust Finance. Your feedback is invaluable to us.</p>
                <p>Thanks,</p>
                <p>The Bridge Trust Finance Team</p>
              </td>
            </tr>
            <tr>
