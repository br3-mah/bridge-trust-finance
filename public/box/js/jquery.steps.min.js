...
!(function (a, b) {
  ...
  var $ = (a.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 }),
    ...
    cb = (a.fn.steps.defaults = {
      ...
      onStepChanging: function (event, currentIndex, newIndex) {
        // Step 1
        var fname = document.getElementById("fnameLoan").value;
        var validatefn = document.getElementById("validfname");
        var lname = document.getElementById("lnameLoan").value;
        var validateln = document.getElementById("validlname");
        var gender = document.getElementById("genderLoan").value;
        var validateGender = document.getElementById("validGender");
        var type = document.getElementById("typeLoan").value;
        var validateType = document.getElementById("validType");
        var duration = document.getElementById("durationLoan").value;
        var validateDuration = document.getElementById("validDuration");
        var phone = document.getElementById("phoneLoan").value;
        var validatePhone = document.getElementById("validPhone");
        var email = document.getElementById("loanEmail").value;
        var validateEmail = document.getElementById("validEmail");
        var amount = document.getElementById("amountLoan").value;
        var validateAmount = document.getElementById("validAmount");

        // Step 2
        var gfname = document.getElementById("checkforthisapplication").value;
        var validategfname = document.getElementById("validgfname");
        var glname = document.getElementById("glname").value;
        var validateglname = document.getElementById("validglname");
        var gRelation = document.getElementById("gRelation").value;
        var validategRelation = document.getElementById("validgRelation");
        var gGender = document.getElementById("gGender").value;
        var validategGender = document.getElementById("validgGender");
        var gEmail = document.getElementById("gEmail").value;
        var validategEmail = document.getElementById("validgEmail");
        var gPhone = document.getElementById("gPhone").value;
        var validategPhone = document.getElementById("validgPhone");

        var g2fname = document.getElementById("g2fname").value;
        var validateg2fname = document.getElementById("validg2fname");
        var g2lname = document.getElementById("g2lname").value;
        var validateg2lname = document.getElementById("validg2lname");
        var g2Relation = document.getElementById("g2Relation").value;
        var validateg2Relation = document.getElementById("validg2Relation");
        var g2Gender = document.getElementById("g2Gender").value;
        var validateg2Gender = document.getElementById("validg2Gender");
        var g2Email = document.getElementById("g2Email").value;
        var validateg2Email = document.getElementById("validg2Email");
        var g2Phone = document.getElementById("g2Phone").value;
        var validateg2Phone = document.getElementById("validg2Phone");

        // Next of Kin
        var nok_fname = document.getElementById("nok_fname").value;
        var validatenok_fname = document.getElementById("validnok_fname");
        var nok_lname = document.getElementById("nok_lname").value;
        var validatenok_lname = document.getElementById("validnok_lname");
        var nok_phone = document.getElementById("nok_phone").value;
        var validatenok_phone = document.getElementById("validnok_phone");
        var nok_email = document.getElementById("nok_email").value;
        var validatenok_email = document.getElementById("validnok_email");
        var nok_relation = document.getElementById("nok_relation").value;
        var validatenok_relation = document.getElementById("validnok_relation");
        var nok_gender = document.getElementById("nok_gender").value;
        var validatenok_gender = document.getElementById("validnok_gender");


        // Step 3
        var payslip = document.getElementById("payslipLoan").value;
        var validatepayslip = document.getElementById("validpayslipLoan");
        var tpin = document.getElementById("tpinLoan").value;
        var validatetpin = document.getElementById("validtpin");
        ...
        switch (currentIndex) {
          ...
          case 0:
              if(fname === ''){
                validatefn.innerHTML = 'Your first name is required!';
              }else{
                validatefn.innerHTML = '';
              }
      
              if(email === ''){
                validateEmail.innerHTML = 'Your email is required!';
              }else{
                validateEmail.innerHTML = '';
              }

              if(lname === ''){
                validateln.innerHTML = 'Your last name is required!';
              }else{
                validateln.innerHTML = '';
              }
              
              if(gender === ''){
                validateGender.innerHTML = 'Your gender is required!';
              }else{
                validateGender.innerHTML = '';
              }
      
              if(type === ''){
                validateType.innerHTML = 'What loan are looking for?';
              }else{
                validateType.innerHTML = '';
              }
      
              if(duration === ''){
                validateDuration.innerHTML = 'Select the duration for repayment';
              }else{
                validateDuration.innerHTML = '';
              }
      
              if(phone === ''){
                validatePhone.innerHTML = 'Your phone number is required!';
              }else{
                validatePhone.innerHTML = '';
              }
      
              if(amount === ''){
                validateAmount.innerHTML = 'How much do you want to get as your loan?';
              }else{
                validateAmount.innerHTML = '';
              }
      
              if(email === '' || fname === '' || lname === '' || gender === '' || type === '' || duration === '' || phone === '' || amount === ''){
          ...
          case 1:
              if(type === 'Personal' || type === 'Home Improvement' || type === 'Vehicle' || type === 'Education'){
                // -----NOK---
                if(nok_fname === ''){
                  validatenok_fname.innerHTML = "Enter Next of Kin's first name";
                }else{
                  validatenok_fname.innerHTML = '';
                }

                if(nok_lname === ''){
                  validatenok_lname.innerHTML = "Enter Next of Kin's surname name";
                }else{
                  validatenok_lname.innerHTML = '';
                }

                if(nok_email === ''){
                  validatenok_email.innerHTML = "Enter Next of Kin's email address";
                }else{
                  validatenok_email.innerHTML = '';
                }

                if(nok_phone === ''){
                  validatenok_phone.innerHTML = "Enter Next of Kin's phone number";
                }else{
                  validatenok_phone.innerHTML = '';
                }

                if(nok_gender === ''){
                  validatenok_gender.innerHTML = "Enter Next of Kin's gender";
                }else{
                  validatenok_gender.innerHTML = '';
                }
                if(nok_relation === ''){
                  validatenok_relation.innerHTML = "Whats your relation with the Next of Kin?";
                }else{
                  validatenok_relation.innerHTML = '';
                }

                if(nok_fname === '' || nok_lname === '' || validatenok_email === '' || validatenok_phone === '' || validatenok_gender === '' || validatenok_relation === ''){
                
                }else{
                  if(gfname === '' || glname === '' || gGender === '' || gEmail === '' || gRelation === '' || gPhone === '' || g2fname === '' || g2lname === '' || g2Gender === '' || g2Email === '' || g2Relation === '' || g2Phone === ''){
                    return !0;
                  }
                  return !0;
                }
                ...
                // For Corporate Loans
                if(gfname === ''){
                  validategfname.innerHTML = "Guarantor's first name is required!";
                }else{
                  validategfname.innerHTML = '';
                }

                if(glname === ''){
                  validateglname.innerHTML = "Guarantor's last name is required!";
                }else{
                  validateglname.innerHTML = '';
                }

                if(gGender === ''){
                  validategGender.innerHTML = 'Gender is required!';
                }else{
                  validategGender.innerHTML = '';
                }

                if(gEmail === ''){
                  validategEmail.innerHTML = 'Email is required!';
                }else{
                  validategEmail.innerHTML = '';
                }

                if(gRelation === ''){
                  validategRelation.innerHTML = 'How are you related?';
                }else{
                  validategRelation.innerHTML = '';
                }

                if(gPhone === ''){
                  validategPhone.innerHTML = "Enter Guarantor's contact phone number";
                }else{
                  validategPhone.innerHTML = '';
                }

                if(g2fname === ''){
                  validateg2fname.innerHTML = "Guarantor's first name is required!";
                }else{
                  validateg2fname.innerHTML = '';
                }

                if(g2lname === ''){
                  validateg2lname.innerHTML = "Guarantor's last name is required!";
                }else{
                  validateg2lname.innerHTML = '';
                }

                if(g2Gender === ''){
                  validateg2Gender.innerHTML = 'Gender is required!';
                }else{
                  validateg2Gender.innerHTML = '';
                }

                if(g2Email === ''){
                  validateg2Email.innerHTML = 'Email is required!';
                }else{
                  validateg2Email.innerHTML = '';
                }

                if(g2Relation === ''){
                  validateg2Relation.innerHTML = 'How are you related?';
                }else{
                  validateg2Relation.innerHTML = '';
                }

                if(g2Phone === ''){
                  validateg2Phone.innerHTML = "Enter Guarantor's contact phone number";
                }else{
                  validateg2Phone.innerHTML = '';
                }
          ...
          case 2:
              if(payslip === ''){
                validatepayslip.innerHTML = 'A copy of your latest payslip is required!';
              }else{
                validatepayslip.innerHTML = '';
              }
      
              if(tpin === ''){
                validatetpin.innerHTML = 'Your ZRA TPIN is required!';
              }else{
                validatetpin.innerHTML = '';
              }
      ...
      onFinished: function () {
        ...
        document.getElementById("webloaderdashboard").style.display = "block";
